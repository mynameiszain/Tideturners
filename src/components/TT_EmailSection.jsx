...
const TT_EmailSection = () => {
  return (
    <section>
        <div class="mx-auto mt-14 max-w-7xl px-6 sm:mt-56 lg:px-8">
            <div class="relative isolate overflow-hidden bg-gray-900 px-6 py-24 shadow-2xl rounded-2xl sm:rounded-3xl sm:px-24 xl:py-32">
                ...
                <p class="mx-auto mt-2 max-w-xl text-center text-lg leading-8 text-gray-300">Keep pace with SecureCloud advancements! Join our mailing list for selective, noteworthy updates.</p>
...
export default TT_EmailSection